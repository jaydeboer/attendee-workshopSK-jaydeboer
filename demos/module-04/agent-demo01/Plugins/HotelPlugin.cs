...
namespace UseSemanticKernelFromNET.Plugins
{
    public class HotelPlugin()
    {
        ...
        [return: Description("Indication if the booking was succesfull")]
        ...
        private AvailableRoom[] availableRooms = new AvailableRoom[]
        {
            ...
            new AvailableRoom { RoomId = 309, RoomType = "Suite", PricePerNight = 320.00m, HotelName = "Budget Stay", NumberOfAdultsAllowedInRoom = 4, Amenities = "Free WiFi, TV, Air Conditioning, Kitchenette", City = "Berlin" },
            ...
            new AvailableRoom { RoomId = 318, RoomType = "Suite", PricePerNight = 410.00m, HotelName = "Mountain Lodge", NumberOfAdultsAllowedInRoom = 4, Amenities = "Free WiFi, TV, Mini Bar, Kitchenette, Fireplace", City = "Denver" },
            ...
            new AvailableRoom { RoomId = 339, RoomType = "Suite", PricePerNight = 355.00m, HotelName = "Opera Hotel", NumberOfAdultsAllowedInRoom = 4, Amenities = "Free WiFi, TV, Mini Bar, Kitchenette", City = "Vienna" },
