...
namespace GloboTicket.Frontend.Services
{
    ...
    public class InMemoryShoppingBasketService: IShoppingBasketService
    {
        ...
        public Task<bool> ShouldApplyAdministrationCost(Guid basketId)
        {
            ...
            decimal subtotal = basket.CalculateSubtotal();
            
            // Fixed: Using decimal for comparison to maintain precision
            return Task.FromResult(subtotal < 500.0m);
        }
        ...
        public Task<decimal> CalculateAdministrationCost(Guid basketId)
        {
            ...
            // Fixed: Using decimal for comparison to maintain precision
            // The administration cost should be removed at exactly 500
            bool shouldApply = subtotal < 500.0m;
